...
func (m *Result) GetErrorCount() uint32 {
	if m != nil {
		return m.ErrorCount
	}
	return 0
...
var fileDescriptor_649f0c502c082470 = []byte{
	...
	,
}
...
func (m *Result) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ErrorCount != 0 {
		i = encodeVarintStreamer(dAtA, i, uint64(m.ErrorCount))
		i--
		dAtA[i] = 0x10
	}
...
func (m *Result) Size() (n int) {
	...
	if m.ErrorCount != 0 {
		n += 1 + sovStreamer(uint64(m.ErrorCount))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
